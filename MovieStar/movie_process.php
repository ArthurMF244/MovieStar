<?php
  ...
  if(isset($_FILES["image"]) && !empty($_FILES["image"]["tmp_name"])) {
    ...
    if(in_array($image["type"], $imageTypes) && exif_imagetype($image["tmp_name"])) {
      ...
      if($imageFile !== false) {
        ...
        if(imagejpeg($imageFile, "./img/movies/" . $imageName, 100)) {
        ...
        $message->setMessage("Tipo inválido de imagem ou arquivo de imagem inválido.", "error", "back");
      }
    }
